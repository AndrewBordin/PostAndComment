...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userDisplayName = header.findViewById(R.id.txtUserDisplayName);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_post) {
            ...
            manager.beginTransaction().replace(
                    R.id.constraintLayoutForFragment,
                    shareFragment,
            ...
            manager.beginTransaction().replace(
                    R.id.constraintLayoutForFragment,
                    groupFragment,
                    groupFragment.getTag()
            ).commit();
        } else if (id == R.id.nav_manage) {
            Toast.makeText(this, "Tools Page", Toast.LENGTH_SHORT).show();
